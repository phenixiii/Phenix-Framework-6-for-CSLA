...
namespace Phenix.Security.Business
{
  ...
  public class DepartmentReadOnlyTreeNode : DepartmentTreeNode<DepartmentReadOnlyTreeNode>
  {
  }
  ...
  /// </summary>
  [Serializable]
  public class DepartmentReadOnlyTree : Phenix.Business.BusinessTreeBase<DepartmentReadOnlyTree, DepartmentReadOnlyTreeNode>
  {
  }
  ...
  /// </summary>
  [Serializable]
  public class DepartmentTreeNode : DepartmentTreeNode<DepartmentTreeNode>
  {
    #region 勾选用户全集
  ...
  /// </summary>
  [Serializable]
  public class DepartmentTree : Phenix.Business.BusinessTreeBase<DepartmentTree, DepartmentTreeNode>
  {
  }
  ...
  public abstract class DepartmentTreeNode<T> : Phenix.Business.BusinessTreeNodeBase<T> where T : DepartmentTreeNode<T>
  {
    /// <summary>
    /// DP_ID
    /// </summary>
