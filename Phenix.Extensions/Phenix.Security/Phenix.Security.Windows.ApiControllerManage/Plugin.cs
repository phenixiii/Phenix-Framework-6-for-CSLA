...
namespace Phenix.Security.Windows.ApiControllerManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<ApiControllerManageForm>(ownerForm);
        return MainForm;
      }
      return BaseForm.ExecuteDialog<ApiControllerManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.ApiControllerManage", null);
    }
  }
}