...
namespace Phenix.Security.Windows.DepartmentManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<DepartmentManageForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<DepartmentManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.DepartmentManage", null);
    }
  }
}