...
namespace Phenix.Security.Windows.RoleManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<RoleManageForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<RoleManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.RoleManage", null);
    }
  }
}