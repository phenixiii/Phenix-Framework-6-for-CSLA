...
namespace Phenix.Security.Windows.TableFilterManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<TableFilterManageForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<TableFilterManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.TableFilterManage", null);
    }
  }
}