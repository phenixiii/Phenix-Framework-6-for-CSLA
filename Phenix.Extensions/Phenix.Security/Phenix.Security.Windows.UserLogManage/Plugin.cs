...
namespace Phenix.Security.Windows.UserLogManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<UserLogManageForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<UserLogManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.UserLogManage", null);
    }
  }
}