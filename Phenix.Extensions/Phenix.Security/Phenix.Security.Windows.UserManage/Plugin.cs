...
namespace Phenix.Security.Windows.UserManage
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<UserManageForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<UserManageForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Security.Windows.UserManage", null);
    }
  }
}