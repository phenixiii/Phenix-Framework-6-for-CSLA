...
namespace Phenix.Workflow.Windows.Desinger
{
  public class Plugin : PluginBase<Plugin>
  {
    ...
    public override object AnalyseMessage(object message)
    {
      ...
      {
        _mainForm = BaseForm.ExecuteMdi<DesignerForm>(ownerForm);
        return _mainForm;
      }
      return BaseForm.ExecuteDialog<DesignerForm>(message);
    }
  }
  ...
  static class Program
  {
    ...
    static void Main()
    {
      ...
      //模拟启动插件
      PluginHost.Default.SendSingletonMessage("Phenix.Workflow.Windows.Desinger", null);
    }
  }
}