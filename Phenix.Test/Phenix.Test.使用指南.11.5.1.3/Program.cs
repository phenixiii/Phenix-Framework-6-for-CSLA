...
namespace Phenix.Test.使用指南._11._5._1._3
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("Fetch一个含有类、类属性的程序集对象：{0}({1})", assembly.Name, assembly.Caption);
      Console.WriteLine();
      ...
      Console.WriteLine();
      Console.WriteLine("建议在处理大批量数据的业务场景下，在业务(集合)类上添加override NotUndoable属性返回true，以阻断CSLA多级撤销机制。");
