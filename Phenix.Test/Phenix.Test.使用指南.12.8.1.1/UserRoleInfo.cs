...
namespace Phenix.Test.使用指南._12._8._1._1
{
  ...
  public abstract class UserRoleInfo<T> : Phenix.Business.BusinessBase<T> where T : UserRoleInfo<T>
  {
    ...
    //* 申明关联的业务类是User，提交时会构建User对象并一起提交
    [Phenix.Core.Mapping.FieldLink(typeof(User), "PH_USER", "US_ID")]
    ...
    //* 申明关联的业务类是Role，提交时会构建Role对象并一起提交
    [Phenix.Core.Mapping.FieldLink(typeof(Role), "PH_ROLE", "RL_ID")]
