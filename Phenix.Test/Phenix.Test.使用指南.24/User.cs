...
namespace Phenix.Test.使用指南._24
{
  ...
  public class User : User<User>
  {
    ...
    {
      get { return GetCompositionDetail<UserRoleList, UserRole>(); }
    }
  }
  ...
  public abstract class User<T> : Phenix.Business.BusinessBase<T> where T : User<T>
  {
    ...
    /// <summary>
    /// US_LASTOPERATIONTIME
    /// </summary>
    public static readonly Phenix.Business.PropertyInfo<DateTime?> LastoperationtimeProperty = RegisterProperty<DateTime?>(c => c.Lastoperationtime);
    [Phenix.Core.Mapping.Field(FriendlyName = "US_LASTOPERATIONTIME", Alias = "US_LASTOPERATIONTIME", TableName = "PH_USER", ColumnName = "US_LASTOPERATIONTIME", NeedUpdate = true)]
    private DateTime? _lastoperationtime;
    /// <summary>
    /// US_LASTOPERATIONTIME
    /// </summary>
    [System.ComponentModel.DataAnnotations.Display(Name = "US_LASTOPERATIONTIME")]
    [System.ComponentModel.DisplayName("US_LASTOPERATIONTIME")]
    public DateTime? Lastoperationtime
    {
      get { return GetProperty(LastoperationtimeProperty, _lastoperationtime); }
      set { SetProperty(LastoperationtimeProperty, ref _lastoperationtime, value); }
    }

    /// <summary>
    /// New
    /// </summary>
    public static T New(string usernumber, string password, DateTime? passwordchangedtime, string name, DateTime? login, DateTime? logout, DateTime? loginfailure, int? loginfailurecount, string loginaddress, long? US_DP_ID, long? US_PT_ID, int? locked, DateTime? lastoperationtime)
    {
      T result = NewPure();
      ...
      result._lastoperationtime = lastoperationtime;
      return result;
    }
    ...
    /// SetFieldValues
    /// </summary>
    protected void SetFieldValues(string usernumber, string password, DateTime? passwordchangedtime, string name, DateTime? login, DateTime? logout, DateTime? loginfailure, int? loginfailurecount, string loginaddress, long? US_DP_ID, long? US_PT_ID, int? locked)
    {
      InitOldFieldValues();
