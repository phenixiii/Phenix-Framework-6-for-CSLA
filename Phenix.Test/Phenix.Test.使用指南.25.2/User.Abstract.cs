...
namespace Phenix.Test.使用指南._25._2
{
  ...
  public abstract class User<T> : Phenix.Business.BusinessBase<T> where T : User<T>
  {
    ...
    public long? US_ID
    {
      ...
      internal set { SetProperty(US_IDProperty, ref _US_ID, value); }
    }
    ...
    [Phenix.Core.Mapping.Field(FriendlyName = "US_LOGIN", Alias = "US_LOGIN", TableName = "PH_USER", ColumnName = "US_LOGIN", NeedUpdate = true)] private DateTime? _login;
    ...
    [Phenix.Core.Mapping.Field(FriendlyName = "US_LOGOUT", Alias = "US_LOGOUT", TableName = "PH_USER", ColumnName = "US_LOGOUT", NeedUpdate = true)] private DateTime? _logout;
    ...
    [Phenix.Core.Mapping.Field(FriendlyName = "US_LOGINFAILURE", Alias = "US_LOGINFAILURE", TableName = "PH_USER", ColumnName = "US_LOGINFAILURE", NeedUpdate = true)] private DateTime? _loginfailure;
    ...
    /// US_LOCKED
    /// </summary>
    public static readonly Phenix.Business.PropertyInfo<int?> LockedProperty = RegisterProperty<int?>(c => c.Locked);
    ...
    [Phenix.Core.Mapping.Field(FriendlyName = "US_PASSWORDCHANGEDTIME", Alias = "US_PASSWORDCHANGEDTIME", TableName = "PH_USER", ColumnName = "US_PASSWORDCHANGEDTIME", NeedUpdate = true)] private DateTime? _passwordchangedtime;
    ...
    /// New
    /// </summary>
    public static T New(string usernumber, string password, string name, DateTime? login, DateTime? logout, DateTime? loginfailure, int? loginfailurecount, string loginaddress, long? US_DP_ID, long? US_PT_ID, int? locked, DateTime? passwordchangedtime)
    {
      T result = NewPure();
    ...
    /// SetFieldValues
    /// </summary>
    protected void SetFieldValues(string usernumber, string password, string name, DateTime? login, DateTime? logout, DateTime? loginfailure, int? loginfailurecount, string loginaddress, long? US_DP_ID, long? US_PT_ID, int? locked, DateTime? passwordchangedtime)
    {
      InitOldFieldValues();
